...
flags.DEFINE_integer('pretraining_epochs', 600, 'Number of training epochs for pretraining layers')  # 60
flags.DEFINE_integer('finetuning_epochs', 560, 'Number of training epochs for fine tuning supervised step')
